                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="input_post_diameter" name="diameter" type="text" placeholder="" class="form-control @error('diameter') is-invalid @enderror" name="diameter" value="{{ old('diameter') }}" />
                                        @error('diameter')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="input_post_length" name="length" type="text" placeholder="" class="form-control @error('length') is-invalid @enderror" name="length" value="{{ old('length') }}" />
                                        @error('length')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="mb-3">
                                        <label for="input_post_title" class="form-label">Name Rusia</label>
